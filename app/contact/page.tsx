      ...
      <section className="pt-32 pb-20 bg-[#F9F5F3] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="animate-fade-up animate-in opacity-0 inline-flex items-center gap-2 glass-panel px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-[#1a2e2f] text-sm font-medium">Get In Touch</span>
          </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            <div>
              <span className="animate-fade-up animate-in opacity-0 inline-flex items-center gap-2 glass-panel px-4 py-2 rounded-full mb-6">
                <Heart className="w-4 h-4 text-[#103B40] fill-[#103B40]" />
                <span className="text-[#1a2e2f] text-sm font-medium">Send Us a Message</span>
              </span>
              <h2 className="animate-fade-up animate-in opacity-0 text-3xl font-display font-semibold text-[#103B40] mb-6">
                We would love to hear from you
              </h2>
              <p className="animate-fade-up animate-in opacity-0 text-[#4a6266] mb-8">
              ...
              {submitted ? (
                <div className="animate-fade-up animate-in opacity-0 glass-card rounded-xl p-8 text-center">
                  <MessageCircle className="w-16 h-16 text-[#103B40] mx-auto mb-4" />
                  <h3 className="text-xl font-display font-semibold text-[#1a2e2f] mb-2">Message Sent!</h3>
                  <p className="text-[#4a6266]">
                    Thank you for reaching out. We will get back to you within 24 hours.
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    className="mt-4 text-[#103B40] hover:underline"
                  >
                ...
                <form onSubmit={handleSubmit} className="animate-fade-up animate-in opacity-0 space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="relative">
                      <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#4a6266]/50" />
                      <input
                        type="text"
                        name="name"
                        value={formData.name}
                        ...
                        required
                        className="w-full bg-white border border-[#103B40]/20 rounded-lg pl-12 pr-4 py-3 text-[#1a2e2f] placeholder-[#4a6266]/40 focus:outline-none focus:border-[#103B40] transition-colors"
                      />
                    </div>
                    <div className="relative">
                      <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#4a6266]/50" />
                      <input
                        type="email"
                        name="email"
                  ...
                  <div className="relative">
                    <FileText className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#4a6266]/50" />
                    <input
                      type="text"
                      name="subject"
                  ...
                  <div className="relative">
                    <MessageCircle className="absolute left-4 top-4 w-5 h-5 text-[#4a6266]/50" />
                    <textarea
                      name="message"
                      ...
                      rows={5}
                      required
                      className="w-full bg-white border border-[#103B40]/20 rounded-lg pl-12 pr-4 py-3 text-[#1a2e2f] placeholder-[#4a6266]/40 focus:outline-none focus:border-[#103B40] transition-colors resize-none"
                    />
                  </div>
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full bg-gradient-to-r from-[#103B40] to-[#246B73] text-white px-8 py-4 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 hover:shadow-xl hover:shadow-[#103B40]/30 transition-all disabled:opacity-50"
                  >
                    {isSubmitting ? (
                      <>
            ...
            <div className="space-y-6">
              <span className="animate-fade-up animate-in opacity-0 inline-flex items-center gap-2 glass-panel px-4 py-2 rounded-full mb-4">
                <Heart className="w-4 h-4 text-[#103B40] fill-[#103B40]" />
                <span className="text-[#1a2e2f] text-sm font-medium">Contact Information</span>
              </span>
              <h2 className="animate-fade-up animate-in opacity-0 text-3xl font-display font-semibold text-[#103B40] mb-8">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-lg font-display font-semibold text-[#1a2e2f] mb-2">{info.title}</h3>
                    <ul className="space-y-1">
                      {info.details.map((detail, i) => (
                        <li key={i} className="text-[#4a6266] text-sm">{detail}</li>
                      ))}
                    </ul>
                  </div>
                ))}
              ...
              <div className="animate-fade-up animate-in opacity-0 mt-8">
                <div className="glass-card rounded-2xl p-8">
                  <h3 className="text-xl font-display font-semibold text-[#1a2e2f] mb-4">Follow Us</h3>
                  <p className="text-[#4a6266] mb-6">
                  ...
                  <div className="flex gap-4">
                    <a 
                      ...
                      className="w-10 h-10 rounded-xl bg-[#103B40]/10 flex items-center justify-center text-[#103B40] hover:bg-[#103B40]/20 transition-all"
                      aria-label="GitHub"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card rounded-3xl p-8 md:p-12">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl md:text-3xl font-display font-semibold text-[#1a2e2f] mb-4">
              ...
              <div className="text-center lg:text-right">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-[#103B40] to-[#246B73] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-xl hover:shadow-[#103B40]/30 transition-all"
                >
