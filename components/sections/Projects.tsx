...
export default function Projects() {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-32 bg-[#103B40] relative overflow-hidden">
      ...
      <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-[#246B73]/20 rounded-full blur-[150px]" />
      <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] bg-[#F2856D]/10 rounded-full blur-[120px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="animate-fade-up animate-in opacity-0 inline-flex items-center gap-2 glass-panel px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-[#F2D7B6]/80 text-sm font-medium">Our Initiatives</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-8">
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${project.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg ${project.glow}`}>
                ...
                <p 
                  className="text-[#F2D7B6]/50 leading-relaxed mb-6"
                  dangerouslySetInnerHTML={{ __html: project.description }}
                />
                
                <Link
                  href="/what-we-do"
                  className="inline-flex items-center gap-2 text-[#F2856D] font-medium hover:gap-3 transition-all group/link"
                >
                  Learn More 
