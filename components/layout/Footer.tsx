        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          <div className="space-y-6">
            ...
            <p className="text-[#F2D7B6]/70 leading-relaxed text-sm">
              Building a world where every individual has access to education, healthcare, and basic human necessities.
            </p>
          ...
          <div>
            <h4 className="text-[#F2D7B6] font-display font-semibold mb-6 text-sm uppercase tracking-wider">Quick Links</h4>
          ...
          <div>
            <h4 className="text-[#F2D7B6] font-display font-semibold mb-6 text-sm uppercase tracking-wider">Our Programs</h4>
            <ul className="space-y-4">
          ...
          <div>
            <h4 className="text-[#F2D7B6] font-display font-semibold mb-6 text-sm uppercase tracking-wider">Get In Touch</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#F2856D] flex-shrink-0 mt-0.5" />
                <span className="text-[#F2D7B6]/70 text-sm">
                  123 Hope Street, Suite 400<br />New York, NY 10001
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-[#F2856D] flex-shrink-0" />
                <a href="tel:+1234567890" className="text-[#F2D7B6]/70 hover:text-[#F2856D] transition-colors text-sm">
                  +1 (234) 567-890
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-[#F2856D] flex-shrink-0" />
                <a href="mailto:info@aspirefoundation.org" className="text-[#F2D7B6]/70 hover:text-[#F2856D] transition-colors text-sm">
